        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">{{ $brand->logo_path ? 'Replace Logo' : 'Upload Logo' }}</label>
                    ...
                    <div id="logoPreview" class="text-center" style="display: none;">
                        ...
                        <div class="p-3" style="background: #f8f9fc; border-radius: 0.5rem;">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="display_order" class="form-control @error('display_order') is-invalid @enderror" 
                               value="{{ old('display_order', $brand->display_order ?? 0) }}" min="0">
