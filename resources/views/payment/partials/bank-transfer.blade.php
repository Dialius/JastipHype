<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="text-center mb-6">
        ...
        <h3 class="text-xl font-bold text-gray-900 mb-2">Transfer Bank {{ $instructions['bank'] }}</h3>
        <p class="text-gray-600">Transfer ke nomor Virtual Account di bawah ini</p>
    </div>
    ...
    <div class="bg-gray-50 rounded-lg p-4">
        ...
        <div class="space-y-3 text-sm text-gray-700">
            <div>
                <p class="font-semibold mb-2">Via ATM BCA:</p>
                <ol class="space-y-1 ml-4 list-decimal">
                    ...
                    <li>Masukkan nomor Virtual Account: <strong>{{ $instructions['va_number'] }}</strong></li>
        ...
        <div class="space-y-3 text-sm text-gray-700">
            <div>
                <p class="font-semibold mb-2">Via ATM BNI:</p>
                <ol class="space-y-1 ml-4 list-decimal">
                    <li>Masukkan kartu ATM dan PIN</li>
                    <li>Pilih menu <strong>Menu Lainnya > Transfer > Rekening Tabungan</strong></li>
        ...
        <div class="space-y-3 text-sm text-gray-700">
            <div>
                <p class="font-semibold mb-2">Via ATM BRI:</p>
                <ol class="space-y-1 ml-4 list-decimal">
                    <li>Masukkan kartu ATM dan PIN</li>
            ...
            <div>
                ...
                <ol class="space-y-1 ml-4 list-decimal">
                    ...
                    <li>Pilih menu <strong>Pembayaran > BRIVA</strong></li>
                    <li>Masukkan nomor Virtual Account: <strong>{{ $instructions['va_number'] }}</strong></li>
                    <li>Konfirmasi detail pembayaran</li>
                    <li>Masukkan PIN</li>
                </ol>
        ...
        <ol class="space-y-2 text-sm text-gray-700">
            <li class="flex items-start">
                ...
                <span>Buka aplikasi mobile banking atau ATM Bank {{ $instructions['bank'] }}</span>
            </li>
            <li class="flex items-start">
                ...
                <span>Pilih menu Transfer atau Pembayaran</span>
            </li>
            <li class="flex items-start">
                ...
                <span>Pilih Virtual Account atau VA Billing</span>
            </li>
            <li class="flex items-start">
                ...
                <span>Masukkan nomor Virtual Account: <strong>{{ $instructions['va_number'] }}</strong></span>
            </li>
            <li class="flex items-start">
                ...
                <span>Konfirmasi pembayaran dan selesaikan transaksi</span>
            </li>
        </ol>
        @endif
    </div>
    ...
    <div class="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
        <p class="text-sm text-yellow-800">
            <strong>Penting:</strong> Transfer harus dilakukan dengan nominal yang tepat. Pembayaran akan otomatis terverifikasi setelah transfer berhasil.
        </p>
    </div>
</div>
